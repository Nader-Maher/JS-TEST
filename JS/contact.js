...
let nameBtn = $("#btnName")
let emailBtn = $("#btnEmail")
let phoneBtn = $("#btnPhone").value
let ageBtn = $("#btnAge").value
let passBtn = $("#btnPass").value
let rePassBtn = $("#btnRePass").value



let nameRegex = /^[A-Z][a-z]{3,15}$/;
// let emailRegex = //;
let phoneRegex = /^(002)?(01)[0-25][0-9]{8}$/;
// let ageRegex = //;
// let passRegex = //;
// let rePassRegex = //;
...
$("#btnName").keyup(function () { 
    ...
    if (nameRegex.test(nameBtn.value))
    {
        console.log("hii")
    }
    else
